...
module.exports = {
  ...
  estonia: {maps: [{ map: "textures/blackwhite/estonia.png" }] },
  ...
  latvia: { maps: [{ map: "textures/blackwhite/latvia.png" }] },
  lithuania: { maps: [{ map: "textures/blackwhite/lithuania.png" }] },
  ...
  russia: {maps: [{ map: "textures/blackwhite/russia.png" }] },
